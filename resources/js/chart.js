...
if (jQuery("#anemometroChart").length) {
    var anemometrosCanvas = document.getElementById('anemometroChart').getContext("2d");
    window.anChart = new Chart(anemometrosCanvas, {
        type: 'line',
        data: {
            labels: labels
        },
...
if (jQuery("#windvaneChart").length) {
    var windvanesCanvas = document.getElementById('windvaneChart').getContext("2d");
    window.wvChart = new Chart(windvanesCanvas, {
        type: 'line',
        data: {
            labels: labels
        },
...
if (jQuery("#barometroChart").length) {
    var barometroCanvas = document.getElementById('barometroChart').getContext("2d");
    window.baChart = new Chart(barometroCanvas, {
        type: 'line',
        data: {
            labels: labels
        },
...
if (jQuery("#temperaturaChart").length) {
    var temperaturaCanvas = document.getElementById('temperaturaChart').getContext("2d");
    window.tempChart = new Chart(temperaturaCanvas, {
        type: 'line',
        data: {
            labels: labels
        },
...
if (jQuery("#umidadeChart").length) {
    var umidadeCanvas = document.getElementById('umidadeChart').getContext("2d");
    window.umiChart = new Chart(umidadeCanvas, {
        type: 'line',
        data: {
            labels: labels
        },
...
if (jQuery("#bateriaChart").length) {
    var bateriaCanvas = document.getElementById('bateriaChart').getContext("2d");
    window.batChart = new Chart(bateriaCanvas, {
        type: 'line',
        data: {
            labels: labels
        },
...
window.addChartData = function (chart, label, data) {
