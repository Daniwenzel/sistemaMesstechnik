...
{{--                        @endif--}}
                    ...
                    <div class="text-wrapper">
                        ...
                        <div>
                            <small class="designation text-muted">{{ Auth::user()->cliente->razaosocial }}</small>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('windfarms.index') }}">
                ...
                <span class="menu-title">{{ __('buttons.tower') }}</span>
            </a>
        </li>
        @role('Admin')
        <li class="nav-item">
            <a class="nav-link" href="{{ route('companies.index') }}">
                ...
                <span class="menu-title">{{ __('buttons.client') }}</span>
            </a>
        </li>
        <li class="nav-item">
